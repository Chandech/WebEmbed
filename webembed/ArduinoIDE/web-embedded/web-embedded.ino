...
#define DEFAULT_AP_SSID  "SPU_2G"
#define DEFAULT_AP_PASS  "25402541"

String apssid = DEFAULT_AP_SSID;
String appass = DEFAULT_AP_PASS;
String myapssid = "SPU_2G"; // Esp32_First-[id]
String myappass = "25402541";
